...
public class ChangeDifficulty : MonoBehaviour
{
    ...
    // set height and width of maze to 10 when user selects easy difficulty level
    public void SetEasy()
    {
        // mazeRenderer = GetComponent<MazeRenderer>();
       // mazeRenderer = GameObject.Find("MazeRenderer").GetComponent<MazeRenderer>();
        mazeRenderer.height = 10;
        mazeRenderer.width = 10;
        Debug.Log("Set difficulty to \"Easy\".");
    }

    // set height and width of maze to 20 when user selects medium difficulty level
    ...
    // set height and width of maze to 30 when user selects hard difficulty level
    public void SetHard()
    {
        //mazeRenderer = GameObject.Find("MazeRenderer").GetComponent<MazeRenderer>();
    ...
    // set height and width of maze to 40 when user selects extreme difficulty level
